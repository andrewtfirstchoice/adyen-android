...
public interface CollectionDao {
    ...
    @Query("SELECT * from collection_table ORDER BY name ASC")
    LiveData<List<CollectionList>> getCollectionsLists();
    ...
    long insert(CollectionList coll);


    @Delete
    void delete(CollectionList collectionList);

    @Query("DELETE FROM collection_table")
    void clear();
    @Update
    void update(CollectionList collectionList);
}
