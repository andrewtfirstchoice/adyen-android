...
public class CameraSourcePreview extends ViewGroup {
  ...
  public void start(CameraSource cSource) throws IOException {
    if (cSource == null) {
      stop();
    }

    this.cameraSource = cSource;
  ...
  public void start(CameraSource cSource, GraphicOverlay overlay) throws IOException {
  ...
  protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
    ...
    try {
      ...
      LoggingHelper.errorMsg(TAG + "Could not start camera source.", e.toString());
    }
  }
