...
class AddressesFragment : Fragment(R.layout.fragment_delivery_addresses) {
    ...
    fun goToAddNewAddress() {
        val bundle = Bundle()
        bundle.putInt("mode", AddressManager.AddressTypes.SHIPPING.ordinal)
        NavHostFragment.findNavController(this).navigate(R.id.action_deliveryAddressesFragment_to_addNewAddressFragment,bundle)
    }
    ...
    private fun setUpToolbar() {
        ...
        binding.toolbar.setNavigationOnClickListener {
            NavHostFragment.findNavController(this@AddressesFragment).navigateUp()
        }
    }
    ...
    internal inner class MyAdapter : RecyclerView.Adapter<MyAdapter.ViewHolder>() {
        ...
        override fun onBindViewHolder(holder: ViewHolder, position: Int) {
            ...
            if (mode == AddressManager.AddressTypes.BILLING) {
                holder.trailing.visibility =
                    if (address.selected_billing) View.VISIBLE else View.INVISIBLE
                isDefault = address.default_billing ?: false
            } else {
                holder.trailing.visibility =
                    if (address.selected_shipping) View.VISIBLE else View.INVISIBLE
        ...
        inner class ViewHolder internal constructor(itemView: View) :
            ...
            val defaultAddressButton: MaterialButton =
                itemView.findViewById(R.id.default_address_button)
